...
def main():
    ...
    print("""
  ######################################
  # BANGALORE Development Environment Setup #
  ######################################

  This script will create your BANGALORE dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BANGALORE project folder:
    [Arma 3 installation directory]\\{} => BANGALORE project folder
    P:\\{}                              => BANGALORE project folder
